<%-- 
    Document   : main
    Created on : 2015. 2. 2, 오전 1:36:52
    Author     : Hajin
--%>
    ...
    <section>
        ...
        <nav class='menu nav navbar-nav col-xs-2'>
            <ul class="list-unstyled">
                <li class="menu-item"><a href="${pageContext.request.contextPath}/StaffHandler" class="btn btn-default btn-primary btn-block">View Tutor</a></li>
